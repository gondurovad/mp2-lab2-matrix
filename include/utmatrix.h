ч// ННГУ, ВМК, Курс "Методы программирования-2", С++, ООП
//
...
{
	if ((s<0) || (si<0) || (si>s) || (s>MAX_VECTOR_SIZE))
...
{
	pos -= StartIndex;
	if (pos < 0 || pos > Size) throw "incorrect data";
	return pVector[pos];
} /*-------------------------------------------------------------------------*/
